    ...
    public String browseWebAndReturnText(String webBrowsingSteps) throws IOException {
        ...
        if (processor != null) {
            try {
                ...
                PWScreenShotAndTextCallback seleniumCallBack = new PWScreenShotAndTextCallback(webBrowsingSteps,seperatedWebBrowsingSteps,result, processor);
                script.process(webBrowsingSteps,seperatedWebBrowsingSteps, seleniumCallBack);
